...
public class Priority {
    ...
    @Min(value = 0, message = "Value of the 'reach in' must be greater than or equal to 0")
    private Long reachIn;

    @NotBlank(message = "Status must have value")
    private String status;

    public Priority(String name, long reachIn, String status) {
        this.name = name;
        this.reachIn = reachIn;
        this.status = status;
    }
